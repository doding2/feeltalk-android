...
import com.clonect.feeltalk.databinding.FragmentKeyRestoringRequestBinding
...
@AndroidEntryPoint
class KeyRestoringRequestFragment : Fragment() {

    private lateinit var binding: FragmentKeyRestoringRequestBinding
    private val viewModel: KeyRestoringRequestViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        binding = FragmentKeyRestoringRequestBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnRequest.setOnClickListener {
            viewModel.requestToRestoreKeys()
        }
    ...
    private fun CoroutineScope.collectRequestButtonEnabled() = launch {
        viewModel.requestButtonEnabled.collectLatest { enabled ->
