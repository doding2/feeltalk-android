...
//    }
//
//    private val callback = object: DiffUtil.ItemCallback<Chat2>() {
...
//
//    private var onItemClickListener: ((Chat2) -> Unit)? = null
//
...
//    }
//
//    fun setOnItemClickListener(listener: (Chat2) -> Unit) {
...
//
//                textChat.text = chat2.message
//                textDate.text = formattedDate(chat2.date)
//
//                root.setOnClickListener { _ ->
//                    onItemClickListener?.let { it(chat2) }
//                }
//            }
//        }
//    }
