...
class ValidateLockResetAnswerUseCase(
    private val tokenRepository: TokenRepository,
    private val accountRepository: AccountRepository,
) {
    suspend operator fun invoke(answer: String): Resource<ValidateLockAnswerDto> {
        ...
        return accountRepository.validateLockResetAnswer(accessToken, answer)
    }
}