...
class ModifyChallengeUseCase(
    ...
    suspend operator fun invoke(index: Long, category: String, title: String, deadline: String, content: String): Resource<Unit> {
        ...
        return challengeRepository.modifyChallenge(accessToken, index, category, title, deadline, content)
    }
}