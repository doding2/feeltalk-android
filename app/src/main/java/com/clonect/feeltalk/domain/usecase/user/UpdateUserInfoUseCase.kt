...
class UpdateUserInfoUseCase(private val userRepository: UserRepository) {
    ...
    suspend operator fun invoke(gender: String, nickname: String, birthDate: String, anniversary: String): Resource<StatusDto> {
        ...
        return userRepository.updateUserInfo(gender, nickname, age, birthDate, anniversary)
    }
