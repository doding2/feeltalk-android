package com.clonect.feeltalk.new_presentation.ui.mainNavigation.chatNavigation.chat.audioVisualizer;
...
public class VisualizerView extends FrameLayout {
    ...
    private static final int DEFAULT_NUM_COLUMNS = 33;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mRenderColor = args.getColor(R.styleable.visualizerView_renderColor, context.getColor(R.color.main_400));
