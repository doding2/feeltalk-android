package com.clonect.feeltalk.new_presentation.ui.chatNavigation.bubble
...
import com.clonect.feeltalk.new_presentation.ui.chatNavigation.chat.ChatViewModel
...
class BubbleActivity : AppCompatActivity() {
    ...
    val onBackCallback = object: OnBackPressedCallback(true) {
        override fun handleOnBackPressed() {
            ...
            this@BubbleActivity.onBackPressedDispatcher.onBackPressed()
        }
    }
...
//            .navigate(R.id.action_mainNavigationFragment_to_contentsShareFragment)
    ...
    private fun startVoiceRecording() {
        checkAudioPermission { isGranted ->
            if (isGranted) {
                viewModel.setVoiceSetupMode(false)
                viewModel.startVoiceRecording(this, binding.vvVoiceVisualizer)
            }
        }
    }
    ...
    private fun replayVoiceRecording() {
        if (viewModel.isVoiceRecordingReplaying.value && viewModel.isVoiceRecordingReplayPaused.value) {
            ...
            viewModel.startVoiceRecordingReplay(this, binding.vvVoiceVisualizer)
        }
    }
